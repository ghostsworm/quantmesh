...
load_language_strings() {
    case $LANG_CODE in
        "zh-CN")
            ...
            LANG_STRINGS["warn_config_not_found"]="找不到 docs/config/examples/config.example.yaml，将跳过配置文件安装"
            ...
            LANG_STRINGS["config_choice_3"]="合并配置（保留旧配置，将示例配置复制为 docs/config/examples/config.example.yaml）"
            ...
            LANG_STRINGS["prompt_start_service"]="是否现在启动 QuantMesh 服务？[Y/n] (默认: Y): "
        ...
        "zh-TW")
            ...
            LANG_STRINGS["warn_config_not_found"]="找不到 docs/config/examples/config.example.yaml，將跳過配置檔案安裝"
            ...
            LANG_STRINGS["config_choice_3"]="合併配置（保留舊配置，將範例配置複製為 docs/config/examples/config.example.yaml）"
            ...
            LANG_STRINGS["prompt_start_service"]="是否現在啟動 QuantMesh 服務？[Y/n] (預設: Y): "
        ...
        "es")
            ...
            LANG_STRINGS["warn_config_not_found"]="No se encontró docs/config/examples/config.example.yaml, se omitirá la instalación del archivo de configuración"
            ...
            LANG_STRINGS["config_choice_3"]="Fusionar configuración (mantener configuración antigua, copiar configuración de ejemplo como docs/config/examples/config.example.yaml)"
            ...
            LANG_STRINGS["prompt_start_service"]="¿Desea iniciar el servicio QuantMesh ahora? [Y/n] (predeterminado: Y): "
        ...
        "fr")
            ...
            LANG_STRINGS["warn_config_not_found"]="docs/config/examples/config.example.yaml introuvable, l'installation du fichier de configuration sera ignorée"
            ...
            LANG_STRINGS["config_choice_3"]="Fusionner la configuration (conserver l'ancienne, copier l'exemple comme docs/config/examples/config.example.yaml)"
            ...
            LANG_STRINGS["prompt_start_service"]="Voulez-vous démarrer le service QuantMesh maintenant? [Y/n] (par défaut: Y): "
        ...
        "ru")
            ...
            LANG_STRINGS["warn_config_not_found"]="docs/config/examples/config.example.yaml не найден, установка конфигурации будет пропущена"
            ...
            LANG_STRINGS["config_choice_3"]="Объединить конфигурацию (сохранить старую, скопировать пример как docs/config/examples/config.example.yaml)"
            ...
            LANG_STRINGS["prompt_start_service"]="Запустить службу QuantMesh сейчас? [Y/n] (по умолчанию: Y): "
        ...
        "hi")
            ...
            LANG_STRINGS["warn_config_not_found"]="docs/config/examples/config.example.yaml नहीं मिला, कॉन्फ़िगरेशन फ़ाइल इंस्टॉलेशन छोड़ा जाएगा"
            ...
            LANG_STRINGS["config_choice_3"]="कॉन्फ़िगरेशन मर्ज करें (पुराना रखें, उदाहरण को docs/config/examples/config.example.yaml के रूप में कॉपी करें)"
            ...
            LANG_STRINGS["prompt_start_service"]="क्या आप अभी QuantMesh सेवा शुरू करना चाहते हैं? [Y/n] (डिफ़ॉल्ट: Y): "
        ...
        "pt")
            ...
            LANG_STRINGS["warn_config_not_found"]="docs/config/examples/config.example.yaml não encontrado, a instalação do arquivo de configuração será ignorada"
            ...
            LANG_STRINGS["config_choice_3"]="Mesclar configuração (manter antiga, copiar exemplo como docs/config/examples/config.example.yaml)"
            ...
            LANG_STRINGS["step_copy_scripts"]="Copiando scripts auxiliares..."
            LANG_STRINGS["info_scripts_copied"]="Scripts auxiliares copiados"
            LANG_STRINGS["prompt_start_service"]="Deseja iniciar o serviço QuantMesh agora? [Y/n] (padrão: Y): "
        ...
        "de")
            ...
            LANG_STRINGS["warn_config_not_found"]="docs/config/examples/config.example.yaml nicht gefunden, Installation der Konfigurationsdatei wird übersprungen"
            ...
            LANG_STRINGS["config_choice_3"]="Konfiguration zusammenführen (alte behalten, Beispiel als docs/config/examples/config.example.yaml kopieren)"
            ...
            LANG_STRINGS["prompt_start_service"]="Möchten Sie den QuantMesh-Dienst jetzt starten? [Y/n] (Standard: Y): "
        ...
        "ko")
            ...
            LANG_STRINGS["warn_config_not_found"]="docs/config/examples/config.example.yaml을 찾을 수 없습니다. 설정 파일 설치를 건너뜁니다"
            ...
            LANG_STRINGS["config_choice_3"]="설정 병합 (기존 유지, 예제를 docs/config/examples/config.example.yaml로 복사)"
            ...
            LANG_STRINGS["prompt_start_service"]="지금 QuantMesh 서비스를 시작하시겠습니까? [Y/n] (기본값: Y): "
        ...
        "ar")
            ...
            LANG_STRINGS["warn_config_not_found"]="لم يتم العثور على docs/config/examples/config.example.yaml، سيتم تخطي تثبيت ملف الإعدادات"
            ...
            LANG_STRINGS["config_choice_3"]="دمج الإعدادات (الاحتفاظ بالقديمة، نسخ المثال كـ docs/config/examples/config.example.yaml)"
            ...
            LANG_STRINGS["prompt_start_service"]="هل تريد بدء خدمة QuantMesh الآن؟ [Y/n] (افتراضي: Y): "
        ...
        "tr")
            ...
            LANG_STRINGS["warn_config_not_found"]="docs/config/examples/config.example.yaml bulunamadı, yapılandırma dosyası yüklemesi atlanacak"
            ...
            LANG_STRINGS["config_choice_3"]="Yapılandırmayı birleştir (eskiyi koru, örneği docs/config/examples/config.example.yaml olarak kopyala)"
            ...
            LANG_STRINGS["prompt_start_service"]="QuantMesh hizmetini şimdi başlatmak istiyor musunuz? [Y/n] (varsayılan: Y): "
        ...
        "vi")
            ...
            LANG_STRINGS["warn_config_not_found"]="Không tìm thấy docs/config/examples/config.example.yaml, sẽ bỏ qua cài đặt tệp cấu hình"
            ...
            LANG_STRINGS["config_choice_3"]="Hợp nhất cấu hình (giữ cũ, sao chép ví dụ thành docs/config/examples/config.example.yaml)"
            ...
            LANG_STRINGS["prompt_start_service"]="Bạn có muốn khởi động dịch vụ QuantMesh ngay bây giờ không? [Y/n] (mặc định: Y): "
        ...
        "it")
            ...
            LANG_STRINGS["warn_config_not_found"]="docs/config/examples/config.example.yaml non trovato, l'installazione del file di configurazione verrà saltata"
            ...
            LANG_STRINGS["config_choice_3"]="Unire la configurazione (mantenere la vecchia, copiare l'esempio come docs/config/examples/config.example.yaml)"
            ...
            LANG_STRINGS["prompt_start_service"]="Avviare il servizio QuantMesh ora? [Y/n] (predefinito: Y): "
        ...
        "id")
            ...
            LANG_STRINGS["warn_config_not_found"]="docs/config/examples/config.example.yaml tidak ditemukan, instalasi file konfigurasi akan dilewati"
            ...
            LANG_STRINGS["config_choice_3"]="Gabungkan konfigurasi (pertahankan yang lama, salin contoh sebagai docs/config/examples/config.example.yaml)"
            ...
            LANG_STRINGS["prompt_start_service"]="Apakah Anda ingin memulai layanan QuantMesh sekarang? [Y/n] (default: Y): "
        ...
        "nl")
            ...
            LANG_STRINGS["warn_config_not_found"]="docs/config/examples/config.example.yaml niet gevonden, installatie van configuratiebestand wordt overgeslagen"
            ...
            LANG_STRINGS["config_choice_3"]="Configuratie samenvoegen (oude behouden, voorbeeld kopiëren als docs/config/examples/config.example.yaml)"
            ...
            LANG_STRINGS["prompt_start_service"]="Wilt u de QuantMesh-service nu starten? [Y/n] (standaard: Y): "
        ...
        *)
            ...
            LANG_STRINGS["warn_config_not_found"]="docs/config/examples/config.example.yaml not found, will skip configuration file installation"
            ...
            LANG_STRINGS["config_choice_3"]="Merge configuration (keep old configuration, copy example as docs/config/examples/config.example.yaml)"
            ...
            LANG_STRINGS["prompt_start_service"]="Do you want to start the QuantMesh service now? [Y/n] (default: Y): "
...
find_config_example() {
    if [ -f "./docs/config/examples/config.example.yaml" ]; then
        CONFIG_EXAMPLE="./docs/config/examples/config.example.yaml"
    elif [ -f "./config.example.yaml" ]; then
        CONFIG_EXAMPLE="./config.example.yaml"
    elif [ -f "${SCRIPT_DIR}/docs/config/examples/config.example.yaml" ]; then
        CONFIG_EXAMPLE="${SCRIPT_DIR}/docs/config/examples/config.example.yaml"
    elif [ -f "${SCRIPT_DIR}/../docs/config/examples/config.example.yaml" ]; then
        CONFIG_EXAMPLE="${SCRIPT_DIR}/../docs/config/examples/config.example.yaml"
...
handle_config() {
    ...
    if [ "$SILENT_MODE" = "1" ]; then
        ...
        if [ -f "$CONFIG_FILE" ]; then
            ...
            [ -n "$CONFIG_EXAMPLE" ] && cp "${CONFIG_EXAMPLE}" "${INSTALL_DIR}/docs/config/examples/config.example.yaml" 2>/dev/null || true
        else
            cp "${CONFIG_EXAMPLE}" "$CONFIG_FILE"
            cp "${CONFIG_EXAMPLE}" "${INSTALL_DIR}/docs/config/examples/config.example.yaml"
        fi
        return
    fi
    ...
    if [ -f "$CONFIG_FILE" ]; then
        ...
        case $config_choice in
            1)
                log_info "$(t "info_config_kept")"
                cp "${CONFIG_EXAMPLE}" "${INSTALL_DIR}/docs/config/examples/config.example.yaml"
                log_info "$(t "info_config_example_copied" "${INSTALL_DIR}/docs/config/examples/config.example.yaml")"
                ;;
            2)
