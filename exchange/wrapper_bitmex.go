...
func (w *bitmexWrapper) BatchCancelOrders(ctx context.Context, symbol string, orderIDs []int64) error {
	...
	return joinOrderOpErrors("batch cancel bitmex orders", errs)
}
...
func (w *bitmexWrapper) CancelAllOrders(ctx context.Context, symbol string) error {
	...
	return joinOrderOpErrors("cancel all bitmex orders", errs)
}
...
func (w *bitmexWrapper) GetFundingInfo(ctx context.Context, symbol string) (*FundingInfo, error) {
