...
// poloniexWrapper Poloniex 包装器
type poloniexWrapper struct {
	adapter *poloniex.Adapter
}

// GetName 獲取交易所名称
func (w *poloniexWrapper) GetName() string {
	return w.adapter.GetName()
}

func (w *poloniexWrapper) GetMarketType() string {
...
func (w *poloniexWrapper) BatchPlaceOrders(ctx context.Context, orders []*OrderRequest) ([]*Order, bool) {
...
func (w *poloniexWrapper) CancelAllOrders(ctx context.Context, symbol string) error {
...
func (w *poloniexWrapper) GetOrder(ctx context.Context, symbol string, orderID int64) (*Order, error) {
	...
	var side Side
	if order.Side == poloniex.SideBuy {
		side = SideBuy
	} else {
		side = SideSell
	}
...
func (w *poloniexWrapper) GetOpenOrders(ctx context.Context, symbol string) ([]*Order, error) {
	orders, err := w.adapter.GetOpenOrders(ctx)
	if err != nil {
		return nil, err
	}
...
// GetAccount 獲取帳戶信息
func (w *poloniexWrapper) GetAccount(ctx context.Context) (*Account, error) {
...
// GetPositions 獲取持倉
func (w *poloniexWrapper) GetPositions(ctx context.Context, symbol string) ([]*Position, error) {
...
// GetBalance 獲取餘額
func (w *poloniexWrapper) GetBalance(ctx context.Context, asset string) (float64, error) {
	return w.adapter.GetBalance(ctx)
}

// StartOrderStream 啟動訂單流
func (w *poloniexWrapper) StartOrderStream(ctx context.Context, callback func(interface{})) error {
	return w.adapter.StartOrderStream(ctx, callback)
}

// StopOrderStream 停止訂單流
func (w *poloniexWrapper) StopOrderStream() error {
	return w.adapter.StopOrderStream()
}

// GetLatestPrice 獲取最新價格
func (w *poloniexWrapper) GetLatestPrice(ctx context.Context, symbol string) (float64, error) {
	return w.adapter.GetLatestPrice(ctx, symbol)
}

// StartPriceStream 啟動價格流
func (w *poloniexWrapper) StartPriceStream(ctx context.Context, symbol string, callback func(price float64)) error {
...
func (w *poloniexWrapper) StartKlineStream(ctx context.Context, symbols []string, interval string, callback CandleUpdateCallback) error {
	return w.adapter.StartKlineStream(ctx, interval, func(candle *poloniex.CandleLocal) {
		callback(&Candle{
...
func (w *poloniexWrapper) StopKlineStream() error {
	return w.adapter.StopKlineStream()
}

// GetHistoricalKlines 獲取歷史 K線
func (w *poloniexWrapper) GetHistoricalKlines(ctx context.Context, symbol string, interval string, limit int) ([]*Candle, error) {
...
func (w *poloniexWrapper) GetPriceDecimals() int {
	return w.adapter.GetPriceDecimals()
}

// GetQuantityDecimals 獲取數量精度
func (w *poloniexWrapper) GetQuantityDecimals() int {
	return w.adapter.GetQuantityDecimals()
}

// GetBaseAsset 獲取基础资產
func (w *poloniexWrapper) GetBaseAsset() string {
	return w.adapter.GetBaseAsset()
}

// GetQuoteAsset 獲取报價资產
func (w *poloniexWrapper) GetQuoteAsset() string {
	return w.adapter.GetQuoteAsset()
}

// GetFundingRate 獲取资金费率
func (w *poloniexWrapper) GetFundingRate(ctx context.Context, symbol string) (float64, error) {
...
func (w *poloniexWrapper) GetOrderFills(ctx context.Context, symbol string, orderID int64) ([]*OrderFill, error) {
	return nil, nil
}
...
func (w *poloniexWrapper) InternalTransfer(ctx context.Context, fromAccount, toAccount, asset string, amount float64) (string, error) {
