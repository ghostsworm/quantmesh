...
func (w *bitrueWrapper) BatchCancelOrders(ctx context.Context, symbol string, orderIDs []int64) error {
	...
	return joinOrderOpErrors("batch cancel bitrue orders", errs)
}
...
func (w *bitrueWrapper) CancelAllOrders(ctx context.Context, symbol string) error {
	...
	return joinOrderOpErrors("cancel all bitrue orders", errs)
}
...
func (w *bitrueWrapper) GetFundingInfo(ctx context.Context, symbol string) (*FundingInfo, error) {
