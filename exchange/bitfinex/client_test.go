...
func TestNewBitfinexClient(t *testing.T) {
	apiKey := "test_api_key"
...
func TestNewAdapter(t *testing.T) {
	...
	adapter, err := NewBitfinexAdapter(config, "BTCUSDT")
	if err != nil {
	...
	if adapter.GetName() != "Bitfinex" {
		t.Errorf("交易所名称错误: 期望 Bitfinex, 得到 %s", adapter.GetName())
	}
}
